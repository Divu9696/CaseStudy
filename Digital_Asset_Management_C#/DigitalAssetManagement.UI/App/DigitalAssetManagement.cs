...
using DigitalAssetManagement.BusinessLayer.Dao.Services;
...
namespace DigitalAssetManagement.UI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("                BY Divyanshu Singh        ");
            Console.WriteLine("========================================");
            Console.ResetColor();
    ...
    // Set up the host builder with configuration from appsettings.json
